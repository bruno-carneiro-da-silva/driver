        ...
        switch (v.getId()) {
            ...
            case R.id.btnNext:
                ...
                if (card_number.equals("") || expiry.equals("") || cvv.equals("")) {
                    Toast.makeText(EnterCardDetailsActivity.this, "Por favor, insira os detalhes primeiro", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    try {
                        //Ryde project stripe
                        Stripe stripe = new Stripe(getApplicationContext(),"pk_live_51IQxguFkZyZ4Q0xJrVgwvRpqBSxc9nNMMpJ4fTMXnHZ0w4kaWmYiYlqBVI1il11ToEa37xIg1C6XXwrWhADXnxW7000AgAbXKj");
