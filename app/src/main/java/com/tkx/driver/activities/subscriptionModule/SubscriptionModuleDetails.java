...
import com.tkx.driver.AddMoneyToWalletActivity;
import com.tkx.driver.CardListActivity;
import com.tkx.driver.HolderServicelayoutSubscription;
...
import com.tkx.driver.others.PlaceHolderZoomOutAnimation;
import com.tkx.driver.samwork.ApiManager;
import com.tkx.driver.samwork.ModelResultCheck;
...
public class SubscriptionModuleDetails extends BaseActivity implements ApiManager.APIFETCHER {
    ...
    @BindView(R.id.package_name1)
    TextView package_name;
    @BindView(R.id.rides_left)
    TextView rides_left;
    @BindView(R.id.valid_till)
    TextView valid_till;
    @BindView(R.id.about_package)
    TextView about_package;
    @BindView(R.id.validity)
    TextView validity;
    @BindView(R.id.image_show1)
    ImageView image_show;
    @BindView(R.id.placeholder_services)
    PlaceHolderView placeHolderViewServices;
    @BindView(R.id.llActivatedPackage)
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    } else if (payment_method.get(which).getId() == 4) {  
                        // online Payment
