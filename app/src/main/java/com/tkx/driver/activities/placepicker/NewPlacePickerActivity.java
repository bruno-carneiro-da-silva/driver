...
public class NewPlacePickerActivity extends AppCompatActivity implements ApiManager.APIFETCHER {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googlemapKey = Config.getEncodedApiKey(getApplicationContext());
...
//        });
    ...
    public String getPlaceAutoCompleteUrl(String input) {
        ...
        urlString.append("&key=" + Config.getEncodedApiKey(getApplicationContext()));
        ...
        private void setOnClick() {
            ...
            AndroidNetworking.get(url).build().getAsString(new StringRequestListener() {
                ...
                public void onError(ANError anError) {
                    Toast.makeText(NewPlacePickerActivity.this, "" + anError.getErrorBody(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
