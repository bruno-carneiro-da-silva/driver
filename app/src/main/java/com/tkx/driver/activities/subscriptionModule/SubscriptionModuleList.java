...
import com.tkx.driver.HolderSubscriptionPackageList;
...
import com.tkx.driver.holder.HolderActivatePackage;
...
public class SubscriptionModuleList extends BaseActivity implements ApiManager.APIFETCHER, Serializable {
    ...
    @BindView(R.id.placeholder_package_list)
    PlaceHolderView placeHolderView;
    @BindView(R.id.placeholder_activate_package)
