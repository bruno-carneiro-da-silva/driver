package com.tkx.driver.manager;
...
public class SessionManager {
    ...
    public static final String KEY_POST_CODE = "postCode_cep";
    ...
    public int getStartTag() {
        return pref.getInt(KEY_START_TAG, 0);
    }

    public void setStartTag(int startTag) {
        Log.d("**" + TAG, "Booking Type = " + startTag);
        editor.putInt(KEY_START_TAG, startTag);
        editor.commit();

    }

    public int getEndTag() {
        return pref.getInt(KEY_END_TAG, 0);
    }

    public void setEndTag(int endTag) {
        Log.d("**" + TAG, "Booking Type = " + endTag);
        editor.putInt(KEY_END_TAG,  endTag);
        editor.commit();

    }

    public String getPolylineAts() {
        return pref.getString(KEY_POLYLINE,"");
    }

    public void setPolylineAts(String polylineAts) {
        Log.d("**" + TAG, "Booking Type = " + polylineAts);
        editor.putString(KEY_POLYLINE,  polylineAts);
        editor.commit();
...
//    }
    ...
    public void setFirebaseNotification(Boolean value) {
        editor.putBoolean(KEY_FIREBASE_NOTI, value);
        editor.commit();
    }

    public boolean getFirebaseNotification() {
        return pref.getBoolean(KEY_FIREBASE_NOTI, false);
    }
    ...
    ,String number,String street,String city,String state_code,String post_code) {
        ...
        editor.putString(KEY_STATE_CODE, state_code);
        editor.putString(KEY_POST_CODE, post_code);
        editor.commit();
    }
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(KEY_STATE_CODE, pref.getString(KEY_STATE_CODE, ""));
        user.put(KEY_POST_CODE, pref.getString(KEY_POST_CODE, ""));
    ...
    public void setOnlineOfflineTag(String appConfig) {

        Log.d("" + TAG, "Adding countries in prefrences");
        editor.putString(ONLINE_OFFLINE_TAG, "" + appConfig);
        editor.commit();
    }


    public ModelDeviceOnlineIffline getOnlineOffileData() {
        ModelDeviceOnlineIffline data = SingletonGson.getInstance().fromJson("" + pref.getString(ONLINE_OFFLINE_TAG, ""), ModelDeviceOnlineIffline.class);
        return data;
    }
    ...
    public void setShow_toll_dialog(boolean manual_toll_enable) {

        editor.putBoolean(MANUAL_TOLL, manual_toll_enable);
        editor.commit();
    }

    public Boolean isShow_toll_dialog() {
        return pref.getBoolean(MANUAL_TOLL, false);
    }
