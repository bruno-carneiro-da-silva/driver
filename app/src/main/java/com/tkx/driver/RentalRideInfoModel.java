...
public class RentalRideInfoModel {
    ...
    public static class DetailsBean {
        ...
        public String getCar_type_antt() {
            return car_type_antt;
        }

        public void setCar_type_antt(String car_type_antt) {
            this.car_type_antt = car_type_antt;
        }
