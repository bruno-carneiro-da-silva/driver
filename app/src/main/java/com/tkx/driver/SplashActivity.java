...
import com.tkx.driver.manager.LanguageManager;
import com.tkx.driver.manager.SessionManager;
import com.tkx.driver.models.ModelAppConfiguration;
import com.tkx.driver.models.ModelDriverDetails;
import com.tkx.driver.models.ModelLogin;
import com.tkx.driver.models.register.Register;
...
public class SplashActivity extends BaseInternetCheckActivity implements ApiManager.APIFETCHER {
    ...
    @BindView(R.id.collection_order_btn)
    LinearLayout collectionOrderBtn;
    ...
    CardView demoLogin;
    @BindView(R.id.tvGettingYourLocation)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceintent = new Intent(SplashActivity.this, MyService.class);
        ...
        loginBtn.setOnClickListener(v -> {
            ...
            it.putExtra("collection_order", "0");
            startActivity(it);
        });

        collectionOrderBtn.setOnClickListener(v -> {
            Intent it = new Intent(SplashActivity.this, LoginActivity.class);
            it.putExtra("collection_order", "1");
            startActivity(it);
        });


        if (BuildConfig.Build_varient.equals("quikr")) {
            gifImageView.setGifImageResource(R.drawable.splash_logo_new);
        }

        // Glide.with(this).load(R.drawable.).into(imageView);
        ...
        llChooseLanguage.setOnClickListener(view -> {
    ...
    protected void onResume() {
        ...
        //  }
        //  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q){
        //      PERMISSIONS = new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_BACKGROUND_LOCATION,Manifest.permission.FOREGROUND_SERVICE};
        //  }else {
        //      PERMISSIONS = new String[]{Manifest.permission.ACCESS_FINE_LOCATION};
        //  }
        //  if (!AppUtils.hasPermissions(SplashActivity.this, PERMISSIONS)) {
    ...
    private void startCheckingLoginProcedure() {
        ...
        if (sessionManager.getUserDetails().get(SessionManager.KEY_SIGNUP_STEP).equals("1")) {
            if (value == null || value.equals("0")) {
                ...
                if(BuildConfig.Build_varient.equals("wemovedriver") || BuildConfig.Build_varient.equals("drivadriver") || BuildConfig.Build_varient.equals("tankydriver")){
                    llChooseLanguage.setVisibility(View.GONE);
                } else {
                    // Não mostrar seleção de linguagem
                    // llChooseLanguage.setVisibility(View.VISIBLE);
                }
    ...
    private void setlanguage() {
        try {
            ...
            if(BuildConfig.Build_varient.equals("twendedriver")){
                sessionManager.setLanguage(sessionManager.getLanguage() == null || sessionManager.getLanguage().equals("") ? "fr" : sessionManager.getLanguage());
            }else if(BuildConfig.Build_varient.equals("mitaxidriver")){
                sessionManager.setLanguage(sessionManager.getLanguage() == null || sessionManager.getLanguage().equals("") ? "es" : sessionManager.getLanguage());
            }
            else if(BuildConfig.Build_varient.equals("onetaxidriver")){
                sessionManager.setLanguage(sessionManager.getLanguage() == null || sessionManager.getLanguage().equals("") ? "pt" : sessionManager.getLanguage());
            }
            else if(BuildConfig.Build_varient.equals("tankydriver")){
                sessionManager.setLanguage(sessionManager.getLanguage() == null || sessionManager.getLanguage().equals("") ? "es" : sessionManager.getLanguage());
            }
            ...
            case API_S.Tags.SET_STRING:
                try {
                   ...
                   // Restring.setStrings("" + obj.get("locale"), stringmap);
                    ...
                    try {
                        Map<String, CharSequence> stringmap = mapper.readValue(obj.get("data") + "", new TypeReference<Map<String, CharSequence>>() {
                        });
                        Locale locale = new Locale("" + obj.get("locale"));
