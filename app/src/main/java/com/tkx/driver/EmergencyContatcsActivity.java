...
import com.tkx.driver.models.ModelDeleteEmergencyContact;
import com.tkx.driver.models.ModelEmergencyContactList;
...
public class EmergencyContatcsActivity extends BaseActivity implements ApiManager.APIFETCHER{
   ...
   @BindView(R.id.placeholder_emergency_contacts)
...
class ContactView {
   ...
   public ContactView(String phone, ApiManager apiManager, SessionManager sessionManager,int id,
    ...
    public void delete(){
        ...
        builder.setMessage(com.tkx.driver.R.string.do_you_really_want_to_delete_this_contact);
