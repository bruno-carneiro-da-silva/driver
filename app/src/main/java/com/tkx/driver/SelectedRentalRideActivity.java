...
import com.tkx.driver.models.restmodels.NewRentalRideDeatilsModel;
import com.tkx.driver.models.restmodels.ResultStatusChecker;
import com.tkx.driver.samwork.ApiManager;
import com.tkx.driver.typeface.TypefaceTextView;
import com.tkx.driver.urls.Apis;
...
public class SelectedRentalRideActivity extends BaseActivity implements ApiManager.APIFETCHER {
    ...
    @BindView(R.id.ll_back_ride_select)
    ...
    @BindView(R.id.rating_selected)
    RatingBar ratingSelected;
    @BindView(R.id.ll_driver_ki_detail)
    LinearLayout llDriverKiDetail;
    @BindView(R.id.tv_car_ima)
    ...
    @BindView(R.id.drop_time_txt)
    TextView dropTimeTxt;
    @BindView(R.id.tv_end_location)
    TextView tvEndLocation;
    @BindView(R.id.ll_location_module)
    ...
    @BindView(R.id.base_package_txt)
    TextView basePackageTxt;
    @BindView(R.id.base_package_price)
    TextView basePackagePrice;
    @BindView(R.id.extra_distance_txt)
    TextView extraDistanceTxt;
    @BindView(R.id.extra_distance_price_txt)
    TextView extraDistancePriceTxt;
    @BindView(R.id.extra_time_txt)
    TextView extraTimeTxt;
    @BindView(R.id.extra_time_price_txt)
    ...
    @BindView(R.id.night_time_price_txt)
    TextView nightTimePriceTxt;
    @BindView(R.id.peak_time_txt)
    TextView peakTimeTxt;
    @BindView(R.id.peak_time_price_txt)
