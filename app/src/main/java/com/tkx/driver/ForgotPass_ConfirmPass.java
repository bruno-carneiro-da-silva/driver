        ...
        register_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (input_newPass.equals("")) {
                    Toast.makeText(ForgotPass_ConfirmPass.this, "Campo obrigatório vazio !", Toast.LENGTH_SHORT).show();
                } else if (input_confirmPass.equals("")) {
                    Toast.makeText(ForgotPass_ConfirmPass.this, "Campo obrigatório vazio !", Toast.LENGTH_SHORT).show();
                } else if (!confirm_pass.getText().toString().equals(new_pass.getText().toString())) {
                    Toast.makeText(ForgotPass_ConfirmPass.this, "Dados de senha não coincidem. Tente novamente!", Toast.LENGTH_SHORT).show();
                } else {
