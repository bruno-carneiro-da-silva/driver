...
import com.tkx.driver.models.ModelWalletBalance;
            ...
            switch (APINAME) {
                ...
                case API_S.Tags.WALLET_BALANCE:
                    ...
                    if (modelWalletBalance.getData().getRecent_transactoin().size() > 0) {
                        ...
                        Snackbar.make(root, com.tkx.driver.R.string.no_view_for_receent_items, Snackbar.LENGTH_SHORT).show();
                    }
                    break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (data.getStringExtra("success").equals("success")) {
                ...
                Toast.makeText(this, com.tkx.driver.R.string.payment_failed, Toast.LENGTH_SHORT).show();


            } else if (data.getStringExtra("aborted").equals("aborted")) {

                Toast.makeText(this, com.tkx.driver.R.string.payment_aborted, Toast.LENGTH_SHORT).show();
