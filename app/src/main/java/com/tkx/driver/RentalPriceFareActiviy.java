...
import com.tkx.driver.models.restmodels.NewDoneRidemodel;
...
public class RentalPriceFareActiviy extends BaseActivity implements ApiManager.APIFETCHER {
   ...
   */ @BindView(R.id.total_price_txt)
    ...
    RatingBar ratingBar;
    @BindView(R.id.ll_submit_rating)
