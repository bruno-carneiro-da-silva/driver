...
import com.tkx.driver.currentwork.holders.HolderBookingDescription;
import com.tkx.driver.currentwork.holders.HolderDriver;
import com.tkx.driver.currentwork.holders.HolderMapImage;
import com.tkx.driver.currentwork.holders.HolderMetering;
import com.tkx.driver.currentwork.holders.HolderPickDropLocation;
import com.tkx.driver.currentwork.holders.HolderReceipt;
...
public class SpecificTripDetailsActivity extends BaseActivity implements ApiManager.APIFETCHER {
    ...
    @BindView(R.id.bottom_text) TextView bottomText;
    @BindView(R.id.cancel_btn_triphistory)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomText.setOnClickListener((View view)->{
            ...
            if(modelSpecificTripDetails.getData().getButton_visibility().getAction().equals("OPEN_TRACKSCREEN")){
                startActivity(new Intent(SpecificTripDetailsActivity.this,TrackerActivity.class).putExtra(""+IntentKeys.BOOKING_ID,""+getIntent().getExtras().getString(""+IntentKeys.BOOKING_ID)));
