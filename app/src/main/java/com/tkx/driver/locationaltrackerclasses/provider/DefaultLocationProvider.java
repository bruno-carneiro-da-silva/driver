package com.tkx.driver.locationaltrackerclasses.provider;
...
public class DefaultLocationProvider extends LocationProvider {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RequestCode.GPS_ENABLE) {
            if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                LogUtils.logI("GPS ativado pelo usuário, recebendo a localização", LogType.GENERAL);
                askForLocation(LocationManager.GPS_PROVIDER);
            } else {
                LogUtils.logI("O usuário não ativou o GPS, então continue com o provedor de rede", LogType.IMPORTANT);
                getLocationByNetwork();
            }
        }
    }
