...
public class ManualRide_Otp_activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Verificando OTP");
                ...
                if (inputValue.length() == 4) {
                    ...
                    try {
                        if(inputValue.equals(""+getIntent().getStringExtra("ride_otp"))){
                            ...
                            Toast.makeText(ManualRide_Otp_activity.this, "PIN errado", Toast.LENGTH_LONG).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                } else {
                    Toast.makeText(ManualRide_Otp_activity.this, "Insira um PIN válido", Toast.LENGTH_LONG).show();
                }
