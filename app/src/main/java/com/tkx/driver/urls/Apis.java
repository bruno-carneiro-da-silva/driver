...
/*    String BASE = "http://apporioinfolabs.com/ApporiotaxiOnesignal/";
    ...
    String CustomerSupport = baseDomain + "driver/customer_support";  //  application(1 for user and 2 for driver)  name  email  phone  query  driver_id  user_id
