...
public class ModelRideInfo {
    ...
    public static class DataBean {
        ...
        public Boolean getDelivery_drop_otp() {
            return delivery_drop_otp;
        }

        public void setDelivery_drop_otp(Boolean delivery_drop_otp) {
            this.delivery_drop_otp = delivery_drop_otp;
        }
        ...
        public boolean isManual_toll_enable() {
            return manual_toll_enable;
        }

        public void setManual_toll_enable(boolean manual_toll_enable) {
            this.manual_toll_enable = manual_toll_enable;
        }
        ...
        public int getOn_site_delivery() {
            return on_site_delivery;
        }

        public void setOn_site_delivery(int on_site_delivery) {
            this.on_site_delivery = on_site_delivery;
        }
