...
public class ModelReceipt {
    ...
    public static class DataBean {
        ...
        public static class PaymentHolderBean {
            ...
            public void setAmount_change(Boolean amount_change) {
                this.amount_change = amount_change;
            }

            public String getAmount_change_text() {
                return amount_change_text;
            }

            public void setAmount_change_text(String amount_change_text) {
                this.amount_change_text = amount_change_text;
            }
