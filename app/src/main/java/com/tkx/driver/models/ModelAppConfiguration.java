...
public class ModelAppConfiguration {
    ...
    public static class DataBean {
         ...
         * customer_support : {"mail":"cabmedriver@gmail.com","phone":"9090909090"}
        ...
        public boolean isAddress_details() {
            return address_details;
        }

        public void setAddress_details(boolean address_details) {
            this.address_details = address_details;
        }

        private boolean address_details;

        public Boolean getShow_polyline() {
            return show_polyline;
        }

        public void setShow_polyline(Boolean show_polyline) {
            this.show_polyline = show_polyline;
        }

        private Boolean show_polyline;

        public Boolean getAdd_wallet_money_enable() {
            return add_wallet_money_enable;
        }

        public void setAdd_wallet_money_enable(Boolean add_wallet_money_enable) {
            this.add_wallet_money_enable = add_wallet_money_enable;
        }
        ...
        public static class GeneralConfigBean {
            ...
            private boolean quick_access_button_visibility;
            private int lat_long_storing_at;

            public int getLat_long_storing_at() {
                return lat_long_storing_at;
            }

            public void setLat_long_storing_at(int lat_long_storing_at) {
                this.lat_long_storing_at = lat_long_storing_at;
            }
            ...
            public boolean isQuick_access_button_visibility() {
                return quick_access_button_visibility;
            }

            public void setQuick_access_button_visibility(boolean quick_access_button_visibility) {
                this.quick_access_button_visibility = quick_access_button_visibility;
            }
