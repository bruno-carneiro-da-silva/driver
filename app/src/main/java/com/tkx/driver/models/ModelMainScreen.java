...
public class ModelMainScreen {
    ...
    public static class DataBean {
        ...
        public boolean isRides_according_to_gender() {
            return rides_according_to_gender;
        }

        public void setRides_according_to_gender(boolean rides_according_to_gender) {
            this.rides_according_to_gender = rides_according_to_gender;
        }
        ...
        public String getRider_gender_choice() {
            return rider_gender_choice;
        }

        public void setRider_gender_choice(String rider_gender_choice) {
            this.rider_gender_choice = rider_gender_choice;
        }
        ...
        public Boolean getGeofence_queue_enable() {
            return geofence_queue_enable;
        }

        public void setGeofence_queue_enable(Boolean geofence_queue_enable) {
            this.geofence_queue_enable = geofence_queue_enable;
        }

        public String getGeofence_queue_text() {
            return geofence_queue_text;
        }

        public void setGeofence_queue_text(String geofence_queue_text) {
            this.geofence_queue_text = geofence_queue_text;
        }

        public String getGeofence_queue_color() {
            return geofence_queue_color;
        }

        public void setGeofence_queue_color(String geofence_queue_color) {
            this.geofence_queue_color = geofence_queue_color;
        }
        ...
        public static class ActiveRidesBean {
             ...
             * email : cabmedriver@cabmedriver.com
