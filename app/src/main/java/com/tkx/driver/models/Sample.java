...
public class Sample {
     ...
     * data : {"country_id":"9","phone_code":"+55","first_name":"Swami","last_name":"Nathan","country_area_id":7,"driver_address":"","login_logout":1,"account_holder_name":"","rating":"4.13","driver_gender":1,"driver_admin_status":"1","signupFrom":"1","current_latitude":"","phoneNumber":"8826900901","email":"swami@cabmedriver.com","account_type_id":"","ats_id":"b32d38328906d1b6_com.tkx.driver","signupStep":"3","account_number":"","wallet_money":"958.00","player_id":"e12fd04c-c134-44ac-8758-dc3c992b1acf","password":"$2y$10$GdFz17f3G34x98V8E5M2gO9.vsTJKsigc7DV8ofuNXpPFDVzhjEz2","id":35,"current_longitude":"","free_busy":2,"profile_image":"https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/driver/1562657325_5d24422d0a90c_driver.jpg","bank_name":"","online_code":"","online_offline":1,"term_status":0,"created_at":"2019-07-09 07:28:50","smoker_type":"2","auto_accept_enable":"","allow_other_smoker":"0","home_location_active":"2","selected_address":"","any_document_expire":false,"totalEarning":{"total_ride":0,"total_earning":"0.00","rating":"4.13/0 Users"},"DriverVehicle":[{"id":28,"merchant_id":1,"driver_id":35,"owner_id":35,"ownerType":1,"vehicle_type_id":16,"shareCode":"dl-1r-y-2336","vehicle_make_id":8,"vehicle_model_id":10,"vehicle_number":"DL 1R Y 2336","vehicle_color":"white","vehicle_image":"https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/vehicle-document/1562657577_5d2443290747c_vehicle_document.jpg","vehicle_number_plate_image":"https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/vehicle-document/1562657580_5d24432c94432_vehicle_document.jpg","vehicle_active_status":1,"vehicle_verification_status":1,"reject_reason_id":null,"ac_nonac":1,"baby_seat":null,"wheel_chair":null,"vehicle_delete":null,"created_at":"2019-07-09 07:33:00","updated_at":"2019-07-09 07:42:14","total_expire_document":null,"vehicle_additional_data":null,"vehicle_id":28}],"driver_commission_choices":[],"subscription_wise_commission":"2","driver_limit":{"radius":null,"latitude":null,"longitude":null},"driver_additional_data":null,"online_transaction_code":{"name":null,"placeholder":"Please enter  Code"},"app_debug_mode":false,"stripe_connect_enable":false,"sc_account_status":"3","sc_account_text":"3"}
     */
    ...
    public static class DataBean {
         ...
         * signupFrom : 1
         * current_latitude :
         * phoneNumber : 8826900901
         * email : swami@cabmedriver.com
         * account_type_id :
         * ats_id : b32d38328906d1b6_com.tkx.driver
         * signupStep : 3
         * account_number :
         * wallet_money : 958.00
         * player_id : e12fd04c-c134-44ac-8758-dc3c992b1acf
         * password : $2y$10$GdFz17f3G34x98V8E5M2gO9.vsTJKsigc7DV8ofuNXpPFDVzhjEz2
         * id : 35
         * current_longitude :
         * free_busy : 2
         * profile_image : https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/driver/1562657325_5d24422d0a90c_driver.jpg
         * bank_name :
         * online_code :
         * online_offline : 1
         * term_status : 0
         * created_at : 2019-07-09 07:28:50
         * smoker_type : 2
         * auto_accept_enable :
         ...
         * totalEarning : {"total_ride":0,"total_earning":"0.00","rating":"4.13/0 Users"}
         * DriverVehicle : [{"id":28,"merchant_id":1,"driver_id":35,"owner_id":35,"ownerType":1,"vehicle_type_id":16,"shareCode":"dl-1r-y-2336","vehicle_make_id":8,"vehicle_model_id":10,"vehicle_number":"DL 1R Y 2336","vehicle_color":"white","vehicle_image":"https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/vehicle-document/1562657577_5d2443290747c_vehicle_document.jpg","vehicle_number_plate_image":"https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/vehicle-document/1562657580_5d24432c94432_vehicle_document.jpg","vehicle_active_status":1,"vehicle_verification_status":1,"reject_reason_id":null,"ac_nonac":1,"baby_seat":null,"wheel_chair":null,"vehicle_delete":null,"created_at":"2019-07-09 07:33:00","updated_at":"2019-07-09 07:42:14","total_expire_document":null,"vehicle_additional_data":null,"vehicle_id":28}]
         * driver_commission_choices : []
         * subscription_wise_commission : 2
         * driver_limit : {"radius":null,"latitude":null,"longitude":null}
         * driver_additional_data : null
         * online_transaction_code : {"name":null,"placeholder":"Please enter  Code"}
        ...
        public DriverLimitBean getDriver_limit() {
            return driver_limit;
        }

        public void setDriver_limit(DriverLimitBean driver_limit) {
        ...
        public boolean isApp_debug_mode() {
            return app_debug_mode;
        }

        public void setApp_debug_mode(boolean app_debug_mode) {
            this.app_debug_mode = app_debug_mode;
        }

        public boolean isStripe_connect_enable() {
            return stripe_connect_enable;
        }

        public void setStripe_connect_enable(boolean stripe_connect_enable) {
            this.stripe_connect_enable = stripe_connect_enable;
        }

        public String getSc_account_status() {
            return sc_account_status;
        }

        public void setSc_account_status(String sc_account_status) {
            this.sc_account_status = sc_account_status;
        }

        public String getSc_account_text() {
            return sc_account_text;
        }

        public void setSc_account_text(String sc_account_text) {
            this.sc_account_text = sc_account_text;
        }
        ...
        public List<?> getDriver_commission_choices() {
            return driver_commission_choices;
        }

        public void setDriver_commission_choices(List<?> driver_commission_choices) {
        ...
        public static class DriverLimitBean {
            /**
             * radius : null
             * latitude : null
             * longitude : null
        ...
        public static class DriverVehicleBean {
             ...
             * ownerType : 1
             * vehicle_type_id : 16
             * shareCode : dl-1r-y-2336
             * vehicle_make_id : 8
             * vehicle_model_id : 10
             * vehicle_number : DL 1R Y 2336
             * vehicle_color : white
             * vehicle_image : https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/vehicle-document/1562657577_5d2443290747c_vehicle_document.jpg
             * vehicle_number_plate_image : https://s3.ap-south-1.amazonaws.com/apporiotaxi-bucket/apporio-taxi/vehicle-document/1562657580_5d24432c94432_vehicle_document.jpg
             ...
             * wheel_chair : null
             * vehicle_delete : null
             * created_at : 2019-07-09 07:33:00
             * updated_at : 2019-07-09 07:42:14
