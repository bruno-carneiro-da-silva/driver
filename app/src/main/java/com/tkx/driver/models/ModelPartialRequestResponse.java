...
public class ModelPartialRequestResponse {
    ...
    public static class DetailsBean {
         ...
         * commission : 20
         * driver_name :
         * driver_email : cabmedriver@cabmedriver.com
