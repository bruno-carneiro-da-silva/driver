...
public class OnlineOfflineActivity extends BaseActivity implements ApiManager.APIFETCHER {
    ...
    @BindView(R.id.close_btn) RelativeLayout close_btn;
    @BindView(R.id.status_description_txt) TextView status_description_txt;
    @BindView(R.id.status__txt) TextView status__txt;
    @BindView(R.id.status_image) ImageView status_image;
    @BindView(R.id.status_btn) LinearLayout status_btn;
