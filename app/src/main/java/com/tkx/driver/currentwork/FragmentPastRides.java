...
public class FragmentPastRides extends BaseFragment implements ApiManager.APIFETCHER, HolderRideHistoryItem.OnBottomReachedListener {
    ...
    public void onBottomReached() {
        if (modelFragmenRides != null) {
            ...
            Toast.makeText(getActivity(), "Modelo passado é nulo", Toast.LENGTH_SHORT).show();
    ...
    public static class HolderRideHistoruPast implements ApiManager.APIFETCHER {
        ...
        private com.tkx.driver.currentwork.HolderRideHistoryItem.OnBottomReachedListener onBottomReachedListener ;
        ...
        public HolderRideHistoruPast(Context context, ModelFragmenRides.DataBean dataBean, boolean isLast, com.tkx.driver.currentwork.HolderRideHistoryItem.OnBottomReachedListener onBottomReachedListener) {
