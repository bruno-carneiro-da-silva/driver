...
import com.tkx.driver.models.ModelNewRequests;
    ...
    private void callActiveAPI() {
        try {
            if (selectModule1.equals("1")) {
                ...
                apiManager._post(API_S.Tags.NEW_REQUESTS, API_S.Endpoints.NEW_REQUESTS, mData, sessionManager);
                ...
                mData.put("latitude", "" + ATS.getLastLocation().getLatitude());
                mData.put("longitude", "" + ATS.getLastLocation().getLongitude());
                apiManager._post(API_S.Tags.NEW_REQUESTS,API_S.Endpoints.DELIVERY_UPCOMING,mData,sessionManager);
            }
        } catch (Exception e) {
