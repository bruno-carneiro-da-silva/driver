...
public class API_S {
    public interface Endpoints {
        ...
        String LOGIN = BuildConfig.BASE_URL + "api/driver/on-board";
        ...
        String DELIVERY_PLACE = BuildConfig.BASE_URL + "api/driver/bookings/delivery/place";
        ...
        String MPESA_ADD_MONEY = BuildConfig.BASE_URL +"api/driver/mpessaAddmoney";
        ...
        String CHANGE_AMOUNT = BuildConfig.BASE_URL + "api/driver/sendMoneyToUser";

        String WAIT_RIDE = BuildConfig.BASE_URL + "api/driver/bookings/pause/resume";

        String GEOFENCE = BuildConfig.BASE_URL + "api/driver/geofence/queue";

        String UPDATE_PLAYER_ID=BuildConfig.BASE_URL+"api/driver/update-player-id";
        String NEW_EARNING_DRIVER = BuildConfig.BASE_URL + "api/driver/account/earnings";

        String CASHOUT_HISTORY = BuildConfig.BASE_URL + "api/driver/cashout/history" ;
        String CASH_OUT =BuildConfig.BASE_URL + "api/driver/cashout/request" ;
        String POLYLINE_API = BuildConfig.BASE_URL+"api/driver/direction-data";
        String PAYPAL_WEBVIEW = BuildConfig.BASE_URL+"api/driver/paypal";
        String NHORA_PAYMENT = BuildConfig.BASE_URL+"api/user/generate/proxypay/reference";
        String CHANGE_RIDE_GENDER = BuildConfig.BASE_URL+"api/driver/changeRideGender";
        String MANUAL_START_RIDE = BuildConfig.BASE_URL+"api/driver/manual/booking/start";
        String ONLINE_PAYMNET = BuildConfig.BASE_URL + "api/driver/online/make-payment";
        String JUNO_PAYMNET = BuildConfig.BASE_URL + "api/driver/juno/card-save/web-view-url";
        String JUNO_CARD_HASH = BuildConfig.BASE_URL + "api/driver/juno/tokenize/cardHash";
        String JUNO_PAYMENT = BuildConfig.BASE_URL + "api/driver/juno/payment";
    }
    ...
    public interface Tags {
        ...
        String DELIVERY_PLACE = "DELIVERY_PLACE";
        ...
        String WAIT_RIDE = "WAIT_RIDE";

        String GEOFENCE = "GEOFENCE";

        String UPDATE_PLAYER_ID ="UPDATE_PLAYER_ID";
        String NEW_EARNING_DRIVER = "NEW_EARNING_DRIVER" ;
        String CASHOUT_HISTORY = "CASHOUT_HISTORY";
        String CASH_OUT ="CASH_OUT" ;
        String POLYLINE_API = "POLYLINE_API";
        String PAYPAL_WEBVIEW = "PAYPAL_WEBVIEW";
        String NHORA_PAYMENT = "NHORA_PAYMENT";
        String CHANGE_RIDE_GENDER= "CHANGE_RIDE_GENDER";
        String MPESA_ADD_MONEY ="MPESA_ADD_MONEY";
        String MANUAL_START_RIDE = "MANUAL_START_RIDE";
        String ONLINE_PAYMNET = "ONLINE_PAYMNET";
        String JUNO_PAYMNET = "JUNO_PAYMNET";
        String JUNO_CARD_HASH = "JUNO_CARD_HASH";
        String JUNO_PAYMENT = "JUNO_PAYMENT";
    }
}
