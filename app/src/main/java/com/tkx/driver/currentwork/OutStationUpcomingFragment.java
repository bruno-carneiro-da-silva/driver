...
public class OutStationUpcomingFragment extends BaseFragment implements ApiManager.APIFETCHER {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        samLocationRequestService = new SamLocationRequestService(getContext());
    }
    ...
    private void callActiveAPI() {
        samLocationRequestService.executeService(location -> {
            try {
                ...
                apiManager._post(API_S.Tags.NEW_UPCOMING_OUSTATIONS, API_S.Endpoints.NEW_OUTSTATION_UPCOMING, mData, sessionManager);
