...
/**
 * Created by cabmedriver 4/8/2017.
 */
...
public class Maputils {
    ...
    public static void moveCameraToSpecificLocation (GoogleMap googleMap , LatLng location ) throws Exception{
        CameraPosition cameraPosition = new CameraPosition.Builder().target(location).zoom(Config.MainScrenZoon).build();
        googleMap.moveCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
    }


    public static void setanimatedicon(LatLng current_latlong , GoogleMap mMap , int ico_image  ){
        //// 28.446890, 77.033478
    ...
    public static Marker setNormalmarker(GoogleMap googlemap, LatLng lat_long, int marker_image) {
        MarkerOptions marker_option = new MarkerOptions().position(lat_long).icon(BitmapDescriptorFactory.fromResource(marker_image)).anchor(0.5f, 0.5f);
