...
// import com.tkx.driver.models.ActiveRidesPool;
// import com.tkx.driver.models.DriverLocation;
...
// /**
// * Created by cabmedriver 3/31/2017.
// */
...
//                    ""+applocation_manager.getLocationDetails().get(LocationSession.KEY_BEARING_FACTOR));
//            try {
//                 // atualizando para a tabela principal do firebase
//                 mDatabaseReference.child(sessionmanager.getUserDetails().get(SessionManager.KEY_DRIVER_ID)).setValue(mDriverLocation);
//                 // geoFire.setLocation(""+sessionmanager.getUserDetails().get(SessionManager.KEY_DRIVER_ID),
...
//                             mDatabaseReference.child(sessionmanager.getUserDetails().get(SessionManager.KEY_DRIVER_ID)).setValue(mDriverLocation);
//                             // criando a identidade do pool de eventos para operá-lo no aplicativo de
//                             // atualizando para a tabela geo do firebase
//                             // atualizando para a tabela geo do firebase
//                             // geoFire.setLocation(""+sessionmanager.getUserDetails().get(SessionManager.KEY_DRIVER_ID),
