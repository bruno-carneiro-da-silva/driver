...
import com.tkx.driver.database.DBHelper;
...
/**
 * Created by cabmedriver 4/28/2017.
 */
...
public class TimeService extends Service implements ApiManager.APIFETCHER {
    ...
    class TimeDisplayTimerTask extends TimerTask {
        ...
        private void updateLocation() {
            Log.d("" + TAG, "Buscando e atualizando localização no Time Service");
            sam_location.executeService(new SamLocationRequestService.SamLocationListener() {
                ...
                public void onLocationUpdate(Location location) {
                    ...
                    LatLng targetLocation = new LatLng(location.getLatitude(), location.getLongitude()); // nome do provedor é desnecessário
                    ...
                    Log.e("Distância da sessão", " " + getDistance(targetLocation, targetLocation1));
    ...
    private void callSocketForLocationUpdate() {
        ...
        mSocket.on("sucess", new Emitter.Listener() {
            ...
            public void call(Object... args) {
                Log.d("*** Notícias sobre soquete ", new Gson().toJson(args));
