...
//                data.put("driver_vehicle", "" + getIntent().getExtras().getString("" + IntentKeys.DRIVER_VEHICLE_ID));
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (modelDriverDocument.getData().getPersonal().size() > 0) {
                                ...
                                for (int i = 0; i < modelDriverDocument.getData().getPersonal().size(); i++) {
                                    placeholder.addView(new HolderDocumentItem(
                                            "" + modelDriverDocument.getData().getPersonal().get(i).getDocument_number_required(),
                                            "" + modelDriverDocument.getData().getPersonal().get(i).getDocumentname(),
                            ...
                            if (modelDriverDocument.getData().getVehicle().size() > 0) {
                                ...
                                for (int i = 0; i < modelDriverDocument.getData().getVehicle().size(); i++) {
                                    placeholder.addView(new HolderDocumentItem(
                                            "" + modelDriverDocument.getData().getVehicle().get(i).getDocument_number_required(),
                                            "" + modelDriverDocument.getData().getVehicle().get(i).getDocumentname(),
    ...
    private class HolderDocumentItem {
        ...
        String vehicleId = "";
        String mDocumentname, mDocumentid, mStatus, expiry_date, mDocumenttype, needStatus,document_number_required;

        public HolderDocumentItem(String document_number_required,String documentname, String doucument_id, String status, String documenttype, String expiry_date, String needStatus, String vehicle_id) {
